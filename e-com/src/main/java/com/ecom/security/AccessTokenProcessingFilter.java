...
import static com.ecom.security.AccessTokenUserDetailsService.PURPOSE_ACCESS_TOKEN;
...
public class AccessTokenProcessingFilter extends AbstractPreAuthenticatedProcessingFilter {
    ...
    private static final Pattern AUTH_PATTERN = Pattern.compile("Ecom ([0-9a-f]+)");
